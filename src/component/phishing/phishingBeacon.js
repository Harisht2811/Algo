...
//                   <p className="phishingDesc">{item.titleDesc}</p>
//                   <p className="phishingDemoBtn " onClick={() => setButtonPopup(true)}>{item.demo}</p>
//               </div>
//               <div className='phishing_section2'>
//                   <p className='phishing_section2Title'>{item.phishingdesc}</p>
//               </div>
//               <div className='phishing_section3'>
//                   <p className='phishing_section3_title'>{item.AlgoritmikTitle}</p>
//                   <img src={hrline} className='phishing_hrline'  alt='hrline'/>
//             <div className='phishing_CardList'>
//             {item.cardList.map(item => {
//                   return<div className='phishingCard'>
//                           <p className='phishingCard_title'>{item.cardTitle}</p>
//                           <p className='phishingCard_desc'>{item.cardDesc}</p>
//                           <p className='darkdemo'>{item.carddemo}<img src={arrowG} className='arrowG' alt='arrow' onClick={() => setButtonPopup(true)}/></p>
//                       </div>
//           })}
//             </div>
//                   <div className='phishing_card3'>
//                       <p className='phishing_card3_title'>{item.remediateTitle}</p>
//                       <p className='phishing_card3_Desc'>{item.remediateDesc}</p>
//                       <p className='darkdemo'>{item.remediateDemo}<img src={arrowG} className='arrowG' alt='arrow' onClick={() => setButtonPopup(true)}/></p>
//                   </div>
//               </div>
//               <div className='phishing_section4'>
//                   <div className='phishing_left'>
//                       <p><img src={item.newImg} alt='backimg'/><br />{item.newTitle}</p>
//                   </div>
//                   <div className='phishing_right'>
//                       <p className='phishing_rightTitle'><img src={phishingLogo} /> {item.phishingtitle}</p>
//                       <p className='phishing_RightDesc'>{item.phishingdesc} <span className='colorText'>{item.phishingColor}</span></p>
//                       <img className='phishingimg' src={item.phishingImg} alt='phishingimg'/>
//                   </div>
//               </div>
//               <div className='phishing_section5'>
//                   <div className='heard'>
