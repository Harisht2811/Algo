...
// import contactData from '../../content/contactData.json'
...
//                 return <div> 
//             <div className='contactBanner'>
//                 <p className='contactTitle1'>{item.title}</p>
//                 <p className='contactTitle2'>{item.discription}</p>
//                 <div className='ContactFlex'>
//                     <div className='contactForm'>
//                         <form className='form'>
//                             <div className='formContent1'>
...
//                     </div>
//                     <div className='ContactPara'>
//                         <p className='ContactParaTitle1'>{item.wordTitle}</p>
//                         <p className='paraContent'>{item.wordContent}</p>
//                         <hr className='ContactHr'></hr>
//                         <p className='ContactParaTitle2'>{item.wordTitle2}</p>
//                         <p className='paraContent2'>{item.wordContent2}</p>
//                         <p className='linkCont'>{item.Email}</p>
//                     </div>
//                 </div>
//                 <div className='meetourTeam'>
//                     <p id='ourteamText'>Meet our team</p>
