    ...
    return (
        ...
        <div>
            <div className='virtual_section1'>
                ...
                <p className="virtual_demoBtn" onClick={() => setButtonPopup(true)}>Enquire Now</p>
            </div>
...
// import virtualdata from '../../content/virtualData.json'
// function Virtual() {
//     const [buttonPopup, setButtonPopup] =useState(false);
...
//         return <div>     
//              <div className='virtual_section1'>
//                   <p className='virtualBtn'>{item.titleBox}</p>
//                   <div className='virtual_Title'>{item.title}</div>
//                   <p className="virtual_demoBtn" onClick={() => setButtonPopup(true)}>{item.demo}</p>
//               </div>
//               <div className='virtualCardlist'>
//                 <div className='virtualcard1'>
//                   {item.cardList.map(item => {
//                     return  <div className='virtualCard'>
//                           <p className='virtualCard_title'>{item.cardTitle}</p>
//                           <img className='vectorHrline' src={item.cardHr} alt='hrline' />
//                           <p className='virtualCard_desc'>{item.cardDesc}</p>
//                           <p className='darkdemo'>{item.cardbtn} <img src={arrowG} className='arrowG' alt='arrow'  onClick={() => setButtonPopup(true)}/></p>
//                       </div>
//                   })}
//                   </div>
//                   <div className='virtualcard1'>
//                   {item.cardList1.map(item => {
//                     return  <div className='virtualCard'>
//                           <p className='virtualCard_title'>{item.cardTitle}</p>
//                           <img className='vectorHrline' src={item.cardHr} alt='hrline' />
//                           <p className='virtualCard_desc'>{item.cardDesc}</p>
...
//                   </div>
//                   <div className='virtualBox'>
//                       <p className='virtualBox_title'>{item.virtualTitle}</p>
//                       <p className='virtualBox_desc'>{item.virtualDesc}</p>
//                   </div>
//               </div>
//               <div className='virtualline_box'>
//                   <div className='virtual_line'>
//                       <div>
//                           <p className='Leveraging_title'>{item.humintTitle}<span className='colorText'> {item.humintTitle1}</span> {item.humintTitle2}</p>
//                       </div>
//                       <div>
//                           <p className='Leveraging_desc1'>{item.humintDesc1}</p>
//                       </div>
//                       <div>
//                           <p className='Leveraging_desc2'>{item.humintDesc2}</p>
//                       </div>
//                     </div>
//                   <img className='horizline' src={vectorHrline} alt='hrilne' />
//                   <div className='virtual_line'>
//                       <div>
//                       <p className='Leveraging_title1'>{item.importantTitle}<span className='colorText'> {item.importantTitle1}</span> {item.importantTitle2}</p>
//                       </div>
//                       <div>
//                           <p className='Leveraging_desc3'>{item.importantDesc1}</p>
//                       </div>
//                       <div>
//                           <p className='Leveraging_desc4'>{item.importantDesc2}</p>
//                       </div>
//                   </div>
//               </div>
//               <div className='virtual_section5'>
