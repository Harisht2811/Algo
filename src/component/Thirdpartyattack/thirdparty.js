    ...
    return (
        <div>
            ...
            <div className='party_section5'>
                <div className='party_section5_box'>
                    <div>
                        <p className='party_box_title'>Heard enough? See it for yourself.</p>
                        <p className='party_box_desc'>Security issues that the penetration test uncovers should be reported to the system owner. Penetration test reports may also assess potential impacts to the organization.</p>
                    </div>
                    <div>
                        <p className='party_box_btn'>Get a Demo</p>
                    </div>
                </div>
            </div>
            </div>
