...
//                         <p className='darkdemo' onClick={() => setButtonPopup(true)}>Enquire Now <img src={arrowG} className='arrowG' /></p>
//                     </div>
...
//                         <p className='darkdemo' >Enquire Now <img src={arrowG} className='arrowG' onClick={() => setButtonPopup(true)}/></p>
//                     </div>
